const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/runtime-python-BiBWmJqd.js","assets/preload-helper-CLcXU_4U.js","assets/globe-renderer-BXgWCotY.js","assets/_commonjsHelpers-Cpj98o6Y.js"])))=>i.map(i=>d[i]);
...
`).replace(/^\s*export\s+default\s+/m,"var __default = "),a=new Function("response",`${n}
  ...
  `;let t;try{t=await b(()=>import("./globe-renderer-BXgWCotY.js"),__vite__mapDeps([2,3]))}catch(e){o.globeCanvas.innerHTML=`
      <div class="globe-placeholder">
