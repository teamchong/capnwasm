...
export class ChatMessageReader {
  ...
  get author() {
    ...
    const _msgEnd = this._msgEnd;
    if (_msgEnd) {
      const v = _jsReadTextPtr(this._u8, this._dv, this._dataPtr, 2, 0, this._msgStart, _msgEnd);
      if (v !== undefined) return v ?? "";
    }
    const len = this._exp.cpp_any_text_at(0);
    if (len === 0) return "";
  ...
  get text() {
    ...
    const _msgEnd = this._msgEnd;
    if (_msgEnd) {
      const v = _jsReadTextPtr(this._u8, this._dv, this._dataPtr, 2, 1, this._msgStart, _msgEnd);
      if (v !== undefined) return v ?? "";
    }
    const len = this._exp.cpp_any_text_at(1);
    if (len === 0) return "";
  ...
  get image() {
    ...
    const _msgEnd = this._msgEnd;
    if (_msgEnd) {
      const v = _jsReadDataPtr(this._u8, this._dv, this._dataPtr, 2, 2, this._msgStart, _msgEnd);
      if (v !== undefined) return v ?? new Uint8Array(0);
    }
  ...
  static _FIELDS = {
    ...
    author: {"kind":0,"off":0,"type":"text"},
    text: {"kind":0,"off":1,"type":"text"},
    ts: {"kind":4,"off":8,"type":"uint64"},
    image: {"kind":6,"off":2,"type":"data"},
  };
...
export class GetSinceParamsReader {
  ...
  static _FIELDS = {
    since: {"kind":4,"off":0,"type":"uint64"},
  };
...
export class ChatMessageListReader {
    ...
    if (_listDesc && _listDesc !== undefined) {
      return {
        ...
        at(i) {
          ...
          return new ChatMessageReader(cpp, elemDataPtr, {
  ...
  static _FIELDS = {
    items: {"kind":-1,"off":0,"type":"List(ChatMessage)"},
  };
...
export class PostParamsBuilder {
  ...
  /**
   * Build a PostParams from a plain JS object in one call.
   * Shorthand for `new PostParamsBuilder(cpp).fromObject(o)`.
   */
  static from(cpp, o) {
    return new PostParamsBuilder(cpp).fromObject(o);
  }
...
export class ChatMessageBuilder {
  ...
  constructor(cpp, opts) {
    ...
    this._exp = cpp._exports;
    if (!opts || !opts.preinitialized) {
      if (this._exp.cpp_any_builder_init(2, 3) !== 1) {
        throw new Error("cpp_any_builder_init failed");
      }
    }
    this._dataPtr = (opts && opts.dataPtr !== undefined)
  ...
  fromObject(o) {
    ...
    if (o.author !== undefined) this.author = o.author;
    if (o.text !== undefined) this.text = o.text;
    if (o.ts !== undefined) this.ts = o.ts;
    if (o.image !== undefined) this.image = o.image;
    return this;
  }

  /**
   * Build a ChatMessage from a plain JS object in one call.
   * Shorthand for `new ChatMessageBuilder(cpp).fromObject(o)`.
   */
  static from(cpp, o) {
    return new ChatMessageBuilder(cpp).fromObject(o);
  }
...
export class GetSinceParamsBuilder {
  static _DATA_WORDS = 1;
  static _PTR_WORDS = 0;
  constructor(cpp, opts) {
    this._cpp = cpp;
  ...
  fromObject(o) {
    if (o == null) return this;
    if (o.since !== undefined) this.since = o.since;
    return this;
  }

  /**
   * Build a GetSinceParams from a plain JS object in one call.
   * Shorthand for `new GetSinceParamsBuilder(cpp).fromObject(o)`.
   */
  static from(cpp, o) {
    return new GetSinceParamsBuilder(cpp).fromObject(o);
  }
...
export class ChatMessageListBuilder {
  static _DATA_WORDS = 0;
  static _PTR_WORDS = 1;
  constructor(cpp, opts) {
    this._cpp = cpp;
  ...
  set items(value) {
    ...
    for (let i = 0; i < value.length; i++) {
      ...
      const sub = new ChatMessageBuilder(this._cpp, { preinitialized: true, capSink: this._capSink });
  ...
  /**
   * Build a ChatMessageList from a plain JS object in one call.
   * Shorthand for `new ChatMessageListBuilder(cpp).fromObject(o)`.
   */
  static from(cpp, o) {
    return new ChatMessageListBuilder(cpp).fromObject(o);
  }
...
/**
 * Open framed Cap'n Proto bytes for typed access. Returns a PostParamsReader.
 */
export function openPostParams(cpp, bytes) {
  const opened = _openCapnwasmMessage(cpp, bytes, false);
  return new PostParamsReader(cpp, opened.dataPtr, opened);
}

/** Open bytes through the shared scratch buffer. Faster, but the reader is valid only until the next CapnCpp message open. */
export function openPostParamsUnsafe(cpp, bytes) {
  const opened = _openCapnwasmMessage(cpp, bytes, true);
  return new PostParamsReader(cpp, opened.dataPtr, opened);
}

/** Begin building a new PostParams message. Returns a PostParamsBuilder. */
export function buildPostParams(cpp) {
  return new PostParamsBuilder(cpp);
}

/**
 * Open framed Cap'n Proto bytes for typed access. Returns a ChatMessageReader.
 */
export function openChatMessage(cpp, bytes) {
  const opened = _openCapnwasmMessage(cpp, bytes, false);
  return new ChatMessageReader(cpp, opened.dataPtr, opened);
}

/** Open bytes through the shared scratch buffer. Faster, but the reader is valid only until the next CapnCpp message open. */
export function openChatMessageUnsafe(cpp, bytes) {
  const opened = _openCapnwasmMessage(cpp, bytes, true);
  return new ChatMessageReader(cpp, opened.dataPtr, opened);
}

/** Begin building a new ChatMessage message. Returns a ChatMessageBuilder. */
export function buildChatMessage(cpp) {
  return new ChatMessageBuilder(cpp);
}

/**
 * Open framed Cap'n Proto bytes for typed access. Returns a GetSinceParamsReader.
 */
export function openGetSinceParams(cpp, bytes) {
  const opened = _openCapnwasmMessage(cpp, bytes, false);
  return new GetSinceParamsReader(cpp, opened.dataPtr, opened);
}

/** Open bytes through the shared scratch buffer. Faster, but the reader is valid only until the next CapnCpp message open. */
export function openGetSinceParamsUnsafe(cpp, bytes) {
  const opened = _openCapnwasmMessage(cpp, bytes, true);
  return new GetSinceParamsReader(cpp, opened.dataPtr, opened);
}

/** Begin building a new GetSinceParams message. Returns a GetSinceParamsBuilder. */
export function buildGetSinceParams(cpp) {
  return new GetSinceParamsBuilder(cpp);
}

/**
 * Open framed Cap'n Proto bytes for typed access. Returns a ChatMessageListReader.
 */
export function openChatMessageList(cpp, bytes) {
  const opened = _openCapnwasmMessage(cpp, bytes, false);
  return new ChatMessageListReader(cpp, opened.dataPtr, opened);
}

/** Open bytes through the shared scratch buffer. Faster, but the reader is valid only until the next CapnCpp message open. */
export function openChatMessageListUnsafe(cpp, bytes) {
  const opened = _openCapnwasmMessage(cpp, bytes, true);
  return new ChatMessageListReader(cpp, opened.dataPtr, opened);
}

/** Begin building a new ChatMessageList message. Returns a ChatMessageListBuilder. */
export function buildChatMessageList(cpp) {
  return new ChatMessageListBuilder(cpp);
}
