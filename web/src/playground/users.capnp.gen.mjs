...
export class UserReader {
  ...
  draft(fn) {
    ...
    return _runDraft(this, UserReader._FIELDS, fn);
  }
...
export class UserListReader {
  ...
  draft(fn) {
    _ensureCapnwasmReader(this);
    if (this._rebind) this._rebind();
    return _runDraft(this, UserListReader._FIELDS, fn);
  }
...
export class CountParamsReader {
  ...
  draft(fn) {
    _ensureCapnwasmReader(this);
    if (this._rebind) this._rebind();
    return _runDraft(this, CountParamsReader._FIELDS, fn);
  }
...
export class BlobReplyReader {
  ...
  draft(fn) {
    _ensureCapnwasmReader(this);
    if (this._rebind) this._rebind();
    return _runDraft(this, BlobReplyReader._FIELDS, fn);
  }
...
export class NumericProbeReader {
  ...
  draft(fn) {
    _ensureCapnwasmReader(this);
    if (this._rebind) this._rebind();
    return _runDraft(this, NumericProbeReader._FIELDS, fn);
  }
...
_STRUCT_META["User"] = { fields: UserReader._FIELDS, dataWords: 3, ptrWords: 3 };
_STRUCT_FIELDS["UserList"] = UserListReader._FIELDS;
_STRUCT_META["UserList"] = { fields: UserListReader._FIELDS, dataWords: 0, ptrWords: 1 };
_STRUCT_FIELDS["CountParams"] = CountParamsReader._FIELDS;
_STRUCT_META["CountParams"] = { fields: CountParamsReader._FIELDS, dataWords: 1, ptrWords: 0 };
_STRUCT_FIELDS["BlobReply"] = BlobReplyReader._FIELDS;
_STRUCT_META["BlobReply"] = { fields: BlobReplyReader._FIELDS, dataWords: 0, ptrWords: 1 };
_STRUCT_FIELDS["NumericProbe"] = NumericProbeReader._FIELDS;
_STRUCT_META["NumericProbe"] = { fields: NumericProbeReader._FIELDS, dataWords: 0, ptrWords: 1 };
